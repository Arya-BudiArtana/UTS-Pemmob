...
class _LoginState extends State<Login> {
  ...
  login() async{
    final response = await http.post("http://169.254.7.85/login/api/login.php", 
    body: {
      "username": username,
      "password": password
    });
...
class _RegisterState extends State<Register> {
  ...
  save() async{
    final response = await http.post("http://169.254.7.85/login/api/register.php", 
    body:{
      "nama": nama,
      "username": username,
      "password": password,
